...
% Select the subject file; autodetect OS
str = computer;
...
%%
% Find trail numbers
% this needs to be deactivated for joystick files (to line 44)
...
% from here on, calculations on data are made
...
% 'sortData' would be replaced with x or y columns
for i = 1:numTrials
