# setwd("//Volumes//mnl//Data//Adaptation//structural_interference//manuscript//R//Routput") # Set wd to output
...
# savepath = "//Volumes//mnl//Data//Adaptation//structural_interference//manuscript//R//Routput" # Set save path for figures

setwd("Z:\\Data\\Adaptation\\structural_interference\\manuscript\\R\\Routput") # Set wd to output
...
savepath = "Z:\\Data\\Adaptation\\structural_interference\\manuscript\\R\\Routput" # Set save path for figures
...
cactus
ggsave("ide.rh.jpeg", plot = last_plot(), device = "jpeg", path = savepath, width = 7.5, height = 4.5, units = "in")
#

# fbrmse exposure and post-exposure, right hand only ---------------------------------------
pd = position_dodge(width = 0.4)
block_ex = subset(rhData_MandSEMbg, rhData_MandSEMbg$phase%in% c(3,4))$block
group_expe = subset(rhData_MandSEMbg, rhData_MandSEMbg$phase%in% c(3,4))$group
ggplot(data = subset(rhData_MandSEMbg, rhData_MandSEMbg$phase%in% c(3,4)), aes(x = block, y = fbrmse_c))+
  geom_point(aes(color = group_expe), position = pd, size = 3)+
  geom_errorbar(data = subset(rhData_MandSEMbg, rhData_MandSEMbg$phase%in% c(3,4)), aes(x = block, ymin = fbrmse_c-fbrmse_c_sem, ymax = fbrmse_c+fbrmse_c_sem, color = group),
                position = pd, width = 0)+
  geom_line(aes(color = group_expe), position = pd, size = 1)+
  #scale_y_continuous(limits = c(-3,7))+
  labs(y = "RMSE (mm)")+
  ...
  geom_vline(xintercept = c(5,12,18), linetype = "dotted")+
  scale_x_continuous(name = "block", breaks = c(5,12,18))
ggsave("fbrmse.rh.jpeg", plot = last_plot(), device = "jpeg", path = savepath, width = 7.5, height = 4.5, units = "in")
#
...
ggplot(data = subset(lhData_MandSEMbg, lhData_MandSEMbg$phase%in% c(3,4)), aes(x = block, y = ide.bc))+
  ...
  geom_vline(xintercept = c(5,12,18), linetype = "dotted")+
  scale_x_continuous(name = "block", breaks = c(5,12,18))
ggsave("ide.bc.jpeg", plot = last_plot(), device = "jpeg", path = savepath, width = 7.5, height = 4.5, units = "in")
#dev.off()
#
...
ggplot(data = subset(lhData_MandSEMbg, lhData_MandSEMbg$phase%in% c(3,4)), aes(x = block, y = ede.bc))+
  ...
  geom_vline(xintercept = c(5,12,18), linetype = "dotted")+
  scale_x_continuous(name = "block", breaks = c(5,12,18))
ggsave("ede.bc.jpeg", plot = last_plot(), device = "jpeg", path = savepath, width = 7.5, height = 4.5, units = "in")
#dev.off()
#
...
ggplot(data = subset(lhData_MandSEMbg, lhData_MandSEMbg$phase%in% c(3,4)), aes(x = block, y = EP_X.bc))+
  ...
  geom_vline(xintercept = c(5,12,18), linetype = "dotted")+
  scale_x_continuous(name = "block", breaks = c(5,12,18))
ggsave("epx.bc.jpeg", plot = last_plot(), device = "jpeg", path = savepath, width = 7.5, height = 4.5, units = "in")
#dev.off()
#
...
#dev.off()
ggsave("latForce.bk1.jpeg", plot = last_plot(), device = "jpeg", path = savepath, width = 7.5, height = 4.5, units = "in")
...
ggplot(data = plot.block, aes(x = sample, y = mean, color = group))+
  ...
  geom_vline(xintercept = c(950), linetype = "dotted")
#dev.off()
ggsave("latForce.bk2.jpeg", plot = last_plot(), device = "jpeg", path = savepath, width = 7.5, height = 4.5, units = "in")
...
ggplot(data = plot.block, aes(x = sample, y = mean, color = group))+
  ...
  geom_vline(xintercept = c(950), linetype = "dotted")
#dev.off()
ggsave("latForce.bk3.jpeg", plot = last_plot(), device = "jpeg", path = savepath, width = 7.5, height = 4.5, units = "in")
#
...
ggplot(data = subset(lhData_MandSEMbg, lhData_MandSEMbg$phase%in% c(3,4)), aes(x = block, y = LFvp.bc))+
  ...
  geom_vline(xintercept = c(5,12,18), linetype = "dotted")+
  scale_x_continuous(name = "block", breaks = c(5,12,18))
ggsave("LFPV.bc.jpeg", plot = last_plot(), device = "jpeg", path = savepath, width = 7.5, height = 4.5, units = "in")
#dev.off()
#
...
ggplot(data = subset(lhData_MandSEMbg, lhData_MandSEMbg$phase%in% c(3,4)), aes(x = block, y = LFoff.bc))+
  ...
  geom_vline(xintercept = c(5,12,18), linetype = "dotted")+
  scale_x_continuous(name = "block", breaks = c(5,12,18))
ggsave("LFOFF.bc.jpeg", plot = last_plot(), device = "jpeg", path = savepath, width = 7.5, height = 4.5, units = "in")
#dev.off()
#
...
ggsave("impVSexp.jpeg", plot = last_plot(), device = "jpeg", path = savepath, width = 7.5, height = 4.5, units = "in")
