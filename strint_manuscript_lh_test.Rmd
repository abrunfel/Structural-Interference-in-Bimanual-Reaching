...
# Baseline correction
lhData = lhData %>% group_by(subjectID) %>% mutate(ide.bc = ide_c - mean(ide_c[trial == 21:40], na.rm = T),
                                                   ede.bc = ede_c - mean(ede_c[trial == 21:40], na.rm = T),
                                                   EP_X.bc = EP_X_c - mean(EP_X_c[trial == 21:40], na.rm = T),
                                                   LFvp.bc = LFvp_FS_c - mean(LFvp_FS_c[trial == 21:40], na.rm = T),
                                                   LFoff.bc = LFoff_FS_c - mean(LFoff_FS_c[trial == 21:40], na.rm = T))
