...
if strcmp(str,'MACI64') == 1
    cd('/Volumes/mnl/Data/Adaptation/structural_interference/Raw_Data');
    fname = uigetfile('*train.zip');
    fname = fname(1:end);
else
    cd('Z:\Data\Adaptation\structural_interference\Raw_Data');
    fname = uigetfile('*train.zip');
    fname = fname(1:end);
end
...
theta(exTrials) = 0; % NOTE: Since we are not analyzing the exposure trials, a zero here will not affect the data
theta(peTrials) = 0;
...
for i = 1:numTrials
    if wrong_trial(i) == 0
        ...
        % Make ide for the 1st and 3rd quad negative
...
if strcmp(str,'MACI64') == 1
    ...
    cd('Z:\Data\Adaptation\structural_interference\Post_Step_1_train');
end
...
% if strcmp(str,'MACI64') == 1
%     cd('/Volumes/mnl/Data/Adaptation/structural_interference/matlab');
% else
%     cd('Z:\Data\Adaptation\structural_interference\matlab');
end